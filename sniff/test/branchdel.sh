...
grep -F '?feat#0000000000000000000000000000000000000000' "$RS_SHARD/refs" \
    >/dev/null || fail "no tombstone row in $RS_SHARD/refs"
note "tombstone row recorded in $RS_SHARD/refs"
