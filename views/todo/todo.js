...
//  CODE-030: the page family (lexer, root, file ladder, head read) is a shared
//  LIBRARY now — work.js reads it there, so this edge no longer comes back.
...
//  CODE-030: the page family moved to shared/ticketpage.js; these are the
//  handles the body (and module.exports below) already spelled by these names.
const EXTS = page.EXTS;
const shape = page.shape, ticketKey = page.ticketKey, keyTopic = page.keyTopic;
const boardDir = page.boardDir, pageFile = page.pageFile, readBytes = page.readBytes;
const pageHead = page.pageHead, pageTitle = page.pageTitle;
const headerMark = page.headerMark, stripMark = page.stripMark;
...
//  CODE-030: work.js no longer requires THIS module (its ticket titles come off
//  shared/ticketpage.js) — the edge is one-way, `worklib` above.
